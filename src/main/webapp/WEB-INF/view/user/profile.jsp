...
<body>
	...
	<div class="container BtZOqO">
		...
		<!-- head -->
		<div class="epUsgf">
			<div class="u6SDuY"><a class="w37kB7" href="/user/account/profile">
					<div class="shopee-avatar">
						<div class="shopee-avatar__placeholder"><svg enable-background="new 0 0 15 15"
							...
							</svg></div><img class="shopee-avatar__img"
							src="https://down-vn.img.susercontent.com/file/083094be4969d6d21d17bc45d2dd00f3_tn">
					</div>
				</a>
				<div class="vDMlrj">
					<div class="HtUK6o">dangdung36</div>
					<div><a class="Kytn1s" href="/user/account/profile"><svg width="12" height="12" viewBox="0 0 12 12"
			...
			<div class="WDmP96">
				...
				<div class="stardust-dropdown stardust-dropdown--open">
					<div class="stardust-dropdown__item-header"><a onclick="displayProfile()" class="jHbobZ" href="#">
							<div class="U7dHrp"><img
									src="https://down-vn.img.susercontent.com/file/ba61750a46794d8847c3f463c5e71cc4">
							</div>
							<div class="mY8KSl"><span class="fnmbfn">Tài khoản của tôi</span></div>
						</a></div>
					<div id="listItemProfile" class="stardust-dropdown__item-body--open">
						<div style="display: block;" class="hGOWVP">
							<a onclick="displayProfile()" class="HVZpoT VfX643" href="#"><span class="PcLlJr">Hồ
									sơ</span></a>
							<a onclick="displayAddress()" class="HVZpoT" href="#"><span class="PcLlJr">Địa
									chỉ</span></a>
							<a onclick="displayChangePass()" class="HVZpoT" href="#"><span class="PcLlJr">Đổi
									mật khẩu</span></a>
						</div>
					</div>
				</div>
				<div class="stardust-dropdown">
					<div class="stardust-dropdown__item-header"><a onclick="displayOders()" class="jHbobZ" href="#">
							<div class="U7dHrp"><img
									src="https://down-vn.img.susercontent.com/file/f0049e9df4e536bc3e7f140d071e9078">
							</div>
							<div class="mY8KSl"><span class="fnmbfn">Đơn Mua</span></div>
						</a></div>
					...
					<form>
						<table class="bQkdAY">
							<tr>
								...
								<td class="o6L4e0">
									<div class="e_Vt__">
										<div class="PBfYlq">dangdung36</div><button class="clo49Q"></button>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="o6L4e0">
									<div>
										<div id="fullname" class="NGoa5Z"><input type="text"
												placeholder="Phạm Đăng Dũng" class="kKnR04" value=""></div>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="o6L4e0">
									<div class="e_Vt__">
										<div class="PBfYlq">du********@gmail.com</div><button class="clo49Q">Thay
											đổi</button>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="o6L4e0">
									<div class="e_Vt__">
										<div class="PBfYlq"></div><button class="clo49Q">Thêm</button>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="o6L4e0">
									<div class="BWTNUj">
										<div class="LFFx8j ZSBTIH" style="position: relative;">
											<div class="DbpS_O hu9cKa"><span class="nnElTN">5</span><svg
											...
											<div class="shopee-popover uCZvY1 fowhUH" aria-role="tooltip"
												style="display: none ;position: absolute; top: 41.3333px; left: 0px; width: 132.948px; z-index: 600;">
												<ul class="tg_mDB">
													<li class="GKDolu">
														<div>1</div>
													</li>
										...
										<div class="LFFx8j ZSBTIH" style="position: relative;">
											<div class="DbpS_O hu9cKa"><span class="nnElTN">Tháng 6</span><svg
													enable-background="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0"
													class="shopee-svg-icon icon-arrow-down">
													<g>
														<path
										...
										<div class="LFFx8j ZSBTIH" style="position: relative;">
											<div class="DbpS_O hu9cKa"><span class="nnElTN">2001</span><svg
													enable-background="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0"
													class="shopee-svg-icon icon-arrow-down">
													<g>
														<path
											...
											<div class="shopee-popover uCZvY1 fowhUH" aria-role="tooltip" style=" display: none;
											position: absolute; top: 41.3333px; left: 0px; width: 132.948px; z-index: 600;">
												<ul class="tg_mDB">
													<li class="GKDolu">
														<div>2024</div>
													</li>
				...
				<div class="nv7bOz">
					<div class="TJWfNh">
						<div class="nMPYiw" role="header">
							<div class="cW0oBM"
								style="background-image: url(&quot;https://down-vn.img.susercontent.com/file/083094be4969d6d21d17bc45d2dd00f3&quot;);">
							</div>
						</div><input class="XbWdh7" type="file" accept=".jpg,.jpeg,.png"><button type="button"
		...
		<div id="address" style=" display: none; margin-left: 40px;" class="YTmAr0 content_body">
				...
				<div>
					<div class="y3hZ9E">
						<div style="display: flex;"><button
								...
								<div class="psXjeQ">
									<div class="zNqMl2"><svg enable-background="new 0 0 10 10" viewBox="0 0 10 10" x="0"
					...
					<div class="UUD4No SXp5o_">
						<div class="_RPpod">
							<div role="heading" class="X57SfF V4So7f">
								<div id="address-card_58a5145f-274e-48f0-878e-7e2495f633d2_header"
									class="QyRpwQ lWXnp3"><span class="Fi1zsg OwAhWT">
										<div class="mjiDsj">phạm đăng dũng</div>
									</span>
									<div class="YJU6OK"></div>
									<div role="row" class="N_WJUf lw_xYb E24UKj">(+84) 385685581</div>
								</div>
								<div class="YziUfM"><button class="T_oZqJ">Cập nhật</button></div>
							</div>
							<div id="address-card_58a5145f-274e-48f0-878e-7e2495f633d2_content" role="heading"
								class="X57SfF V4So7f">
								<div class="QyRpwQ lWXnp3">
									<div class="We6XvC">
										<div role="row" class="E24UKj">thôn 1 - định công</div>
										<div role="row" class="E24UKj">Xã Định Công, Huyện Yên Định, Thanh Hóa</div>
									</div>
								</div>
								<div class="KFu3R3 YziUfM"><button class="k8tV5Y zvyzwn zDPndA" disabled="">Thiết lập
										mặc định</button></div>
							</div>
							<div id="address-card_58a5145f-274e-48f0-878e-7e2495f633d2_badge" role="row"
								class="vy2yND E24UKj"><span role="mark" class="wZ_1w7 aCY_5O ZDVTqW">Mặc định</span>
							</div>
						</div>
					</div>
					<div class="UUD4No SXp5o_">
						<div class="_RPpod">
							<div role="heading" class="X57SfF V4So7f">
								<div id="address-card_e410527b-0954-4245-8e4f-976a4a122fc8_header"
									class="QyRpwQ lWXnp3"><span class="Fi1zsg OwAhWT">
										<div class="mjiDsj">Phạm dũng</div>
									</span>
									<div class="YJU6OK"></div>
									<div role="row" class="N_WJUf lw_xYb E24UKj">(+84) 339185601</div>
								</div>
								<div class="YziUfM"><button class="T_oZqJ">Cập nhật</button><button
										class="T_oZqJ">Xóa</button></div>
							</div>
							<div id="address-card_e410527b-0954-4245-8e4f-976a4a122fc8_content" role="heading"
								class="X57SfF V4So7f">
								<div class="QyRpwQ lWXnp3">
									<div class="We6XvC">
										<div role="row" class="E24UKj">236 Khương Đình</div>
										<div role="row" class="E24UKj">Phường Hạ Đình, Quận Thanh Xuân, Hà Nội</div>
									</div>
								</div>
								<div class="KFu3R3 YziUfM"><button class="k8tV5Y zvyzwn zDPndA">Thiết lập mặc
										định</button></div>
							</div>
							<div id="address-card_e410527b-0954-4245-8e4f-976a4a122fc8_badge" role="row"
								class="vy2yND E24UKj"></div>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- change password -->
		<div id="change_pass" style="display: none;" class="mainDiv content_body">
			<div class="cardStyle">
		...
		<div id="oders" style="width: 100%; display: none;" class="fkIi86 content_body">
				...
				<div class="ashFMQ">
					...
					<section class="QmO3Bu" aria-role="tablist">
						...
						<a class="KI5har mRVNLm" title="Tất cả" aria-role="tab"
							aria-selected="true" aria-controls="olp_panel_id-0.011495566464603701"
							id="olp_tab_id-0.011495566464603701" href="#"><span class="NoH9rC">Tất
								cả</span></a>
						<a class="KI5har" title="Chờ thanh toán" aria-role="tab"
							aria-selected="false" aria-controls="olp_panel_id-0.6878425174620506"
							id="olp_tab_id-0.6878425174620506" href="#"><span class="NoH9rC">Chờ
								thanh toán</span></a>
						<a class="KI5har" title="Vận chuyển" aria-role="tab"
							aria-selected="false" aria-controls="olp_panel_id-0.6875429166932798"
							id="olp_tab_id-0.6875429166932798" href="#"><span class="NoH9rC">Vận
								chuyển</span></a>
						<a class="KI5har" title="Chờ giao hàng" aria-role="tab"
							aria-selected="false" aria-controls="olp_panel_id-0.773446413725138"
							id="olp_tab_id-0.773446413725138" href="#"><span class="NoH9rC">Chờ giao
								hàng</span></a>
						<a class="KI5har" title="Hoàn thành" aria-role="tab"
							aria-selected="false" aria-controls="olp_panel_id-0.9298067800804086"
							id="olp_tab_id-0.9298067800804086" href="#"><span class="NoH9rC">Hoàn
								thành</span></a>
						<a class="KI5har" title="Đã hủy" aria-role="tab" aria-selected="false"
							aria-controls="olp_panel_id-0.8340847480608564" id="olp_tab_id-0.8340847480608564"
							href="#"><span class="NoH9rC">Đã hủy</span></a>
						<a class="KI5har"
							title="Trả hàng/Hoàn tiền" aria-role="tab" aria-selected="false"
							aria-controls="olp_panel_id-0.22121322300552904" id="olp_tab_id-0.22121322300552904"
							href="#"><span class="NoH9rC">Trả hàng/Hoàn tiền</span></a>
					</section>
					<section>
						<h2 class="a11y-hidden"></h2>
						<div class="Gv8cvd"><svg width="19px" height="19px" viewBox="0 0 19 19">
							...
							</svg><input aria-label="" role="search" autocomplete="off"
								placeholder="Bạn có thể tìm kiếm theo tên Shop, ID đơn hàng hoặc Tên Sản phẩm" value="">
						</div>
					</section>
					<main aria-role="tabpanel" aria-labelledby="olp_tab_id-0.011495566464603701"
							...
							<div class="YL_VlX">
								<div>
									<div class="J632se">
										<section>
											...
											<div class="P2JMvg">
												<div class="RBPP9y">
													<div class="Koi0Pw"><svg xmlns="http://www.w3.org/2000/svg"
															width="62" height="16" fill="none">
													...
													<div class="UDaMW3" tabindex="0">ỐP LƯNG IPHONE -SIÊU THỊ AWiFi
													</div>
													<div class="B2SOGC"><button
															class="stardust-button stardust-button--primary"><svg
																viewBox="0 0 17 17"
															...
															</svg><span>chat</span></button></div><a class="Mr26O7"
														href="/awifi?entryPoint=OrderDetail">
														<div class="stardust-button"><svg
																enable-background="new 0 0 15 15" viewBox="0 0 15 15"
																x="0" y="0" class="shopee-svg-icon icon-btn-shop">
																<path
												...
												<div class="jgIyoX">
													<div class="LY5oll"><a class="lXbYsi"
															href="/user/purchase/order/119338331267953?type=6"><span
																class="O2yAdQ"><svg enable-background="new 0 0 15 15"
										...
										<section>
											<h3 class="a11y-hidden"></h3><a aria-label=""
													...
													<div class="bdAfgU">
														<div class="FNHV0p">
															<div>
																<section>
																	<div class="mZ1OWk">
																		<div class="dJaa92"><img
																				src="https://down-vn.img.susercontent.com/file/13c7287bce651a7cee01a681d1f4fe1f_tn"
																				class="gQuHsZ" alt="" tabindex="0">
																			<div class="nmdHRf">
																				<div>
																					<div class="zWrp4w"><span
																							class="DWVWOJ"
																							tabindex="0">Tai nghe nhét
																							tai có dây U19 giắc cắm
																							3.5mm tích hợp micro chất
																							lượng cao dành cho điện
																							thoại - Awifi Case
																							L3-2</span></div>
																				</div>
																				<div>
																					<div class="rsautk" tabindex="0">
																						Phân loại hàng: Tai Nghe U19 Đen
																					</div>
																					<div class="j3I_Nh" tabindex="0">x1
																					</div>
																				</div>
																			</div>
																		</div>
																		<div class="ylYzwa" tabindex="0">
																			<div class="YRp1mm"><span
																					class="q6Gzj5">₫28.000</span><span
								...
								<div class="LwXnUQ">
									<div class="NWUSQP"><span class="R_ufN9">
										...
										<div class="t7TQaf" tabindex="0" aria-label="Thành tiền: ₫29.500">₫29.500</div>
									</div>
								</div>
								<div class="yyqgYp">
									<div class="iwUeSD">
									...
									<section class="po9nwN">
										<h3 class="a11y-hidden"></h3>
										<div class="aAXjeK">
											<div><button class="stardust-button stardust-button--primary QY7kZh">Mua
													lại</button></div>
										</div>
										<div class="hbQXWm">
											<div><button class="stardust-button stardust-button--secondary QY7kZh">Liên
							...
							<div class="YL_VlX">
										...
										<section>
											...
											<div class="P2JMvg">
												<div class="RBPP9y">
													...
													<div class="UDaMW3" tabindex="0">Shop thể thao 247 Max Rẻ</div>
													<div class="B2SOGC"><button
															class="stardust-button stardust-button--primary"><svg
																viewBox="0 0 17 17"
																class="shopee-svg-icon icon-btn-chat"
												...
												<div class="jgIyoX">
													<div class="LY5oll"><a class="lXbYsi"
														...
														<div class="shopee-drawer" id="pc-drawer-id-3" tabindex="0"><svg
																enable-background="new 0 0 15 15" viewBox="0 0 15 15"
																x="0" y="0" class="shopee-svg-icon icon-help">
																<g>
																		...
																		<div class="dJaa92"><img
																			...
																			<div class="nmdHRf">
																				<div>
																					<div class="zWrp4w"><span
																							class="DWVWOJ"
																							tabindex="0">Kìm Bóp Tay Kìm
																							Tập Cơ Tay Dụng Cụ Tập Gym
																							Tại Nhà Điều Chỉnh Lực
																							10-60kg Có Đếm số tự
																							động</span></div>
																				</div>
																				<div>
																					<div class="rsautk" tabindex="0">
																						Phân loại hàng: Lò Xo Không Đếm
																						Số,Ngẫu nhiên</div>
																					<div class="j3I_Nh" tabindex="0">x1
																					</div>
																				</div>
								...
								<div class="LwXnUQ">
									<div class="NWUSQP"><span class="R_ufN9">
										...
										<div class="t7TQaf" tabindex="0" aria-label="Thành tiền: ₫51.500">₫51.500</div>
									</div>
								</div>
								<div class="yyqgYp">
									<div class="iwUeSD">
									...
									<section class="po9nwN">
										...
										<div class="hbQXWm">
											<div><button class="stardust-button stardust-button--secondary QY7kZh">Xem
													đánh giá Người mua</button></div>
										</div>
									</section>
								</div>
							</div>
	...
	<script type="text/javascript" src='<c:url value="/assets/js/profile.js" />'>
